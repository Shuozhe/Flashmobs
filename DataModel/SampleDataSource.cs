...
namespace Flashmobs.Data
{
    ...
    public abstract class SampleDataCommon : Flashmobs.Common.BindableBase
    {
        private static Uri _baseUri = new Uri("ms-appx:///");

        public SampleDataCommon(String uniqueId, String title, String Place, String imagePath, String description, String time = "soon")
        {
    ...
    {
        public SampleDataItem(String uniqueId, String title, String subtitle, String imagePath, String description, String content, SampleDataGroup group, String time = "soon")
            : base(uniqueId, title, subtitle, imagePath, description, time)
        {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            // Einfache lineare Suche ist bei kleinen DataSets akzeptabel.
            SampleDataItem item = GetItem(uniqueId);
            SampleDataGroup group = GetGroup(item.Group.UniqueId);
            //var matches = _sampleDataSource.AllGroups.SelectMany(group => group.Items).Where((item) => item.UniqueId.Equals(uniqueId));
            group.Items.Remove(item);
            //_sampleDataSource.AllGroups.r;
        }
        ...
        public SampleDataSource()
        {
            ...
            var group1 = new SampleDataGroup("Group-1",
                    "Bald",
                    "Flashmobs, die in Kürze stattfinden",
                    "Assets/kitlogo.jpg",
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-2",
                    "Burger King Fressmob",
                    "Burger King, Karlsruhe",
                    "Assets/burger.jpg","",
                    "Was das soll? Initiator Pascal Heinrichs versucht das so zu erklären: 'Ich will beweisen, dass man in einer Stadt wie Karlsruhe auch so etwas machen kann. Es geht darum, was Großes zu machen. Das Ziel ist es, den Burger King leer zu kaufen. Es sollte von jedem Artikel etwas gekauft werden.' Also: Freie Auswahl bei den Produkten! Hauptsache man kommt vorbei und macht den Spaß mit.",
                    
                    group1,
                    "01.12.2012"));
            group1.Items.Add(new SampleDataItem("Group-1-Item-3",
                    "Freeze auf dem Marktplatz",
                    "Marktplatz, Karlsruhe",
                    "Assets/freez.jpg","",
                    "Start- und Endsignal? Ein dreifacher, deutlicher Trillerpfeifenpfiff. Das Signal sollte überall gut zu hören sein. ***Pfiffe vor 15 Uhr bitte ignorieren*** Wer kann mitmachen? Prinzipiell jeder. Du musst einfach nur zum Treffpunkt kommen. Bring am besten Freunde mit – je mehr desto besser! Worauf muss ich achten? Sei vorher unauffällig und bilde keine Grüppchen. Passanten sollen überrascht sein! Denk Dir eine kreative Pose aus, die Du auch wirklich für 5 Minuten halten kannst. Geh nach dem Endsignal einfach wieder los.",
            ...
            var group2 = new SampleDataGroup("Group-2",
                    "Zukunft",
                    "Flashmobs, die etwas später stattfinden",
                    "Assets/kitlogo.jpg",
                    "");
            group2.Items.Add(new SampleDataItem("Group-2-Item-1",
                    "Breakdance/Dance Mob in Freiburg",
                    "Vorm Alnatura in der Innenstadt, Freiburg",
                    "Assets/dance.jpg","",
                    "Hey an alle Mitstreiter :) Wir treffen uns um 15:00 in der Erbprinzenstr. 6 um ein wenig zu üben und anschließend um 16:00 vor dem Alnatura abzudancen. Wer will kann gerne zur Vorbereitung kommen, oder ihr denkt euch selbst etwas aus und tanzt einfach mit. Wichtig ist, dass die Leute nicht merken, dass um 16:00 etwas passieren wird, also lasst euch nichts anmerken! Wir freuen uns auf euch, bis dann!",
